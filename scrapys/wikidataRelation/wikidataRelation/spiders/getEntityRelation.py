...
class entityRelationSpider(scrapy.spiders.Spider):
	...
	def parse(self, response):
		...
		#获取已经爬取的数据(避免重复爬)
		alreadyGet = []
		if(os.path.exists("D:\Projects\Python\EduKnowledgeGraph\Scrapys\wikidataRelation\entity1_entity2_raw.json")):
			#读取文件
			with open("D:\Projects\Python\EduKnowledgeGraph\Scrapys\wikidataRelation\entity1_entity2_raw.json",'r',encoding = 'UTF-8') as fr:
				for line in fr:
